...
Aplicación simulada de Home Banking en español con datos de prueba. 
...
- **Exploratory Testing** (exploración libre de la aplicación)
- **Smoke Testing** (pruebas básicas de estabilidad)
- **Functional Testing** (pruebas de funcionalidad principal)
- **Negative Testing** (pruebas con datos inválidos y manejo de errores)
- **Boundary Value Analysis** (pruebas de valores límite y edge cases)
- **Usability / UI Testing** básico (claridad de mensajes y experiencia de usuario)
