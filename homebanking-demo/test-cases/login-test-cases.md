...
| SEC-07 | Acceso mediante botón Atrás luego del logout      | Usuario autenticado                     | 1. Iniciar sesión.<br>2. Cerrar sesión.<br>3. Presionar el botón Atrás del navegador.                                    | No se muestra contenido protegido o se redirige nuevamente al Login.                | Alta      |
